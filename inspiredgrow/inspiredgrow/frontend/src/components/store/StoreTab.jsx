    ...
    <div className="mx-auto overflow-y-auto">
      <form onSubmit={handleSubmit}>
        <div className="flex gap-20">
          ...
          <div className="flex gap-32 w-full">
            <div className="space-y-4 w-full">
              <div>
                <label htmlFor="storeCode" className="block font-medium mb-2">
                  Store Code*
                </label>
                <input
                  id="storeCode"
              ...
              <div>
                <label htmlFor="gstNumber" className="block font-medium mb-2">
                  GST Number
                </label>
                <input
                  id="gstNumber"
              ...
              <div>
                <label htmlFor="taxNumber" className="block font-medium mb-2">
                  TAX Number
                </label>
                <input
                  id="taxNumber"
              ...
              <div>
                <label htmlFor="storeWebsite" className="block font-medium mb-2">
                  Store Website
                </label>
                <input
                  id="storeWebsite"
        ...
        <div className="flex justify-center gap-4 mt-10">
          ...
          <button type="button" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-6 rounded-md">
            Close
          </button>
        </div>
      </form>
