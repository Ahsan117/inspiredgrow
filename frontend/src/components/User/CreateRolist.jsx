...
const CreateRolelist = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedPermissions = Object.keys(permissions).map((module) => ({
      ...
      add: permissions[module]?.includes("Add"),
      edit: permissions[module]?.includes("Edit"),
      delete: permissions[module]?.includes("Delete"),
      view: permissions[module]?.includes("View"),
    }));
          ...
          <div className="bg-white shadow-md rounded-lg p-8">
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    {modules.map((module, index) => (
                      <tr key={module.id}>
                        ...
                        <td className="border px-4 py-2 text-center">
                          <input
                            type="checkbox"
                            checked={permissions[module.name]?.length === permissionTypes.length}
              ...
              <div className="mt-6 flex justify-center gap-10">
                <button type="submit" className="bg-green-500 w-[150px] text-white px-4 py-2 rounded-md">
                  Save
                </button>
                <button
                  type="button"
